...
PATH = "~/Documents/Projects/MR-mediation-CM-MM/output/OUTPUT-2024/DEPRESSION/olink/adjusted-b-path-md/"
setwd(PATH)
# define path to functions
FUNCTIONS = "~/Documents/Projects/MR-mediation-CM-MM/scripts/TIDY-WORKFLOW/source/" 
SUMSTATS="~/Documents/Projects/MR-mediation-CM-MM/summary-stats/OLINK/Kaviar-160204-Public/vcfs/"
